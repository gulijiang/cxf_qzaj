...
/**
 * TbTagHis entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "TB_TAG_HIS", schema = "QZAJ")
public class TbTagHis implements java.io.Serializable {
	...
	/** minimal constructor */
	public TbTagHis(Integer tagId) {
		this.tagId = tagId;
	}

	@Id
	@Column(name = "TAG_ID", unique = true, nullable = false, precision = 11, scale = 0)
	@GeneratedValue(strategy = GenerationType.SEQUENCE,generator="SEQ_TAG_HIS")
	@SequenceGenerator (name= "SEQ_TAG_HIS" , sequenceName= "SEQ_TAG_HIS" ,allocationSize = 1, initialValue = 1) 
